                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                <tr>
                                    ...
                                    <td>
                                        <a href="details.html" class="text-gray-800 text-hover-primary mb-1">Emma
                                            Smith</a>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('customer.view') }}" class="menu-link px-3">
                                                    View
                                                </a>
                                            </div>
                                            <!--end::Menu item-->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="details.html" class="text-gray-800 text-hover-primary mb-1">Melody
                                            Macy</a>
                                    </td>
                                    <td>
                                        <a href="#"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="details.html" class="text-gray-800 text-hover-primary mb-1">Mikaela
                                            Collins</a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="details.html" class="text-gray-800 text-hover-primary mb-1">Francis
                                            Mitcham</a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="details.html" class="text-gray-800 text-hover-primary mb-1">Olivia
                                            Wild</a>
                                    </td>
                                    <td>
                                        <a href="#"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="details.html" class="text-gray-800 text-hover-primary mb-1">Dan
                                            Wilson</a>
                                    </td>
                                    <td>
                                        <a href="#"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="details.html" class="text-gray-800 text-hover-primary mb-1">Robert
                                            Doe</a>
                                    </td>
                                    <td>
                                        <a href="#"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="details.html" class="text-gray-800 text-hover-primary mb-1">John
                                            Miller</a>
                                    </td>
                                    <td>
                                        <a href="#"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="details.html" class="text-gray-800 text-hover-primary mb-1">Lucy
                                            Kunic</a>
                                    </td>
                                    <td>
                                        <a href="#"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="details.html" class="text-gray-800 text-hover-primary mb-1">Neil
                                            Owen</a>
                                    </td>
                                    <td>
                                        <a href="#"
