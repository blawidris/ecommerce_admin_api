                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="kt_ecommerce_settings_store" role="tabpanel">
                                ...
                                <form id="kt_ecommerce_settings_general_store" class="form"
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-9">
                                            <!--begin::Input-->
                                            <textarea class="form-control form-control-solid" name="store_address">{{ $store->store_address ?? '' }}</textarea>
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-9">
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid"
                                                name="store_geocode" value="{{ $store->store_geocode ?? '' }}" />
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input type="email" class="form-control form-control-solid"
                                                name="store_email" value="{{ $store->store_email ?? '' }}" />
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-9">
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid"
                                                name="store_phone" value="{{ $store->store_phone ?? '' }}" />
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-9">
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid"
                                                name="meta_title" value="{{ $store->meta_title ?? '' }}" />
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                            ...
                            <div class="tab-pane fade" id="kt_ecommerce_settings_localization" role="tabpanel">
                                ...
                                <form id="kt_ecommerce_settings_general_localization" class="form"
                                    data-submit-url="/setting/localization">

                                    @csrf

                                    <input type="hidden" name="tab" value="2">
                                    <input type="hidden" name="name" value="localize">
                                    <!--begin::Heading-->
                                    <div class="row mb-7">
                                        <div class="col-md-9 offset-md-3">
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <select id="kt_ecommerce_localization_country"
                                                ...
                                                <option></option>
                                                @if ($local->country ?? false)
                                                    <option value="{{ $local->country }}"
                                                        {{ $local->country ? 'selected' : '' }}>{{ $local->country }}
                                                    </option>
                                                @endif
                                                <option value="AF"
                                        ...
                                        <div class="col-md-9">
                                            <div class="w-100">
                                                ...
                                                <select class="form-select form-select-solid" name="language"
                                                    ...
                                                    <option></option>
                                                    @if ($local->language ?? '')
                                                        <option value="{{ $local->language }}"
                                                            {{ $local->language ? 'selected' : '' }}>
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-9">
                                            <div class="w-100">
                                                <!--begin::Select2-->
                                                <select class="form-select form-select-solid" name="length"
                                                    data-control="select2" data-hide-search="true"
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-9">
                                            <div class="w-100">
                                                <!--begin::Select2-->
                                                <select class="form-select form-select-solid" name="weight"
                                                    data-control="select2" data-hide-search="true"
                            ...
                            <div class="tab-pane fade" id="kt_ecommerce_settings_customers" role="tabpanel">
                                ...
                                <!--begin::Form-->
                                <form id="kt_ecommerce_settings_general_customers" class="form" data-submit-url="">
                                    <!--begin::Heading-->
                                    <div class="row mb-7">
                                        <div class="col-md-9 offset-md-3">
